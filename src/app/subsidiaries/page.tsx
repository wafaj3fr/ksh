...
export default function Subsidiaries() {
  ...
  return (
    <main className="px-8 sm:px-20 py-16 bg-white text-gray-800">
      ...
      <h1 className="text-4xl font-bold mb-8">Our Subsidiaries</h1>
      {/* Sector-based grouping and individual subsidiary profiles */}
      {/* Example: */}
      <section>
        <h2 className="text-2xl font-semibold mb-4">Technology</h2>
        {/* Map over tech subsidiaries */}
      </section>
      <section>
        <h2 className="text-2xl font-semibold mb-4">Real Estate</h2>
        {/* Map over real estate subsidiaries */}
      </section>
      {/* ...other sectors */}
    </main>
  );
