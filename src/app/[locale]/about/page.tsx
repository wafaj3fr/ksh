        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 items-center gap-12">
          <div className="space-y-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              Established in [Year] under the Sudanese Companies Law, the
              Kuwaiti Sudanese Holding Company (KSHC) emerged as a
              foreign-capital investment leader committed to economic growth,
              innovation, and Sudan’s prosperity. Our ventures span across
              strategic sectors, driven by a unified goal of building a
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-gray-700">
                We focus on projects and companies that enhance productivity and
                create tangible positive impacts on society. Our aim is to
                improve quality of life through sustainable investments.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-700 max-w-2xl mx-auto">
                We operate across a diverse set of sectors with innovative
      ...
      <section className="bg-white px-6 sm:px-20 py-24">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              Over the next five years, KSHC is on a mission to become a
              regional investment powerhouse. By uniting our companies under one
              umbrella and driving strategic innovation, we aim to create a
              diversified investment ecosystem that builds a better future for
              Sudan and beyond.
            </p>
          </div>
          <Image
      ...
      <section className="bg-[#f7f9fc] px-6 sm:px-20 py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700 leading-loose text-justify">
            The Kuwaiti Sudanese Holding Company takes pride in being a Kuwaiti
            company with foreign capital, dedicated to economic development in
            Sudan. Our mission is grounded in integrity, progress, and long-term
            success. As we continue this journey, we remain committed to our
            principles, our people, and our purpose — to build a prosperous
