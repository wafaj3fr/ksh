...
export default function Footer() {
  return (
    <footer
      className="bg-gray-900 text-gray-100 pt-16 pb-8  w-full min-h-[400px]
"
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-20 grid grid-cols-1 sm:grid-cols-3 gap-12 items-start">
        ...
        {/* Quick Links */}
        <div>
          <h3 className="text-lg font-semibold text-[#B49C5B] mb-4">
            Quick Links
          </h3>
          <ul className="space-y-2">
            <li>
              <a href="/about" className="hover:text-[#B49C5B] transition">
                About Us
              </a>
            </li>
            <li>
              <a
                href="/subsidiaries"
                className="hover:text-[#B49C5B] transition"
              >
                Subsidiaries
              </a>
            </li>
            <li>
              <a href="/news" className="hover:text-[#B49C5B] transition">
                News & Media
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/contact" className="hover:text-[#B49C5B] transition">
                Contact
              </a>
            </li>
          </ul>
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li>
              ...
              <a
                ...
                className="hover:text-[#B49C5B] transition"
              >
                +249 900 922 906 | +249 900 922 905
              </a>
            </li>
            <li>
      ...
      <div className="border-t border-gray-700 mt-12 pt-6 text-center text-gray-500 text-sm">
        &copy; 2025 Kuwaiti Sudanese Holding Company (KSHC). All rights
        reserved.
      </div>
    </footer>
  );
