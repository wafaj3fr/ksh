      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-20 grid grid-cols-1 sm:grid-cols-3 gap-12 items-start">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/about" className="hover:text-[#B49C5B] transition">
                {t("about")}
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/news" className="hover:text-[#B49C5B] transition">
                {t("news")}
              </Link>
            </li>
            <li>
              <Link href="/careers" className="hover:text-[#B49C5B] transition">
                {t("careers")}
              </Link>
            </li>
            <li>
              <Link href="/contact" className="hover:text-[#B49C5B] transition">
                {t("contact")}
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li>
              <span className="block text-gray-300">{t("email")}</span>
              <a
            ...
            <li>
              <span className="block text-gray-300">{t("phone")}</span>
              <a
            ...
            <li>
              <span className="block text-gray-300">{t("address")}</span>
