      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            investment group that keeps pace with the latest investment
            developments in Sudan. It is committed to leading in its unique
            fields, striving for excellence through integrated efforts in all
            its investments. Established with the goal of leadership, the
            company oversees numerous ventures, each contributing individually
            and collectively to the realization of the company’s core
            objectives.
          </p>
