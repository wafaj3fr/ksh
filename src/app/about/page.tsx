  ...
  {isOpen && (
    <div className="absolute top-20 right-8 bg-white/80 backdrop-blur-md shadow-lg p-6 rounded-xl flex flex-col gap-4 sm:hidden border border-white/30">
      ...
      <section className="mb-12">
        ...
        <p> {/* Company journey, milestones, achievements */} </p>
      </section>
      {/* Vision, Mission, Values */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-2">Vision, Mission & Values</h2>
        <p> {/* Vision, Mission, Values content */} </p>
      </section>
      {/* Organizational Structure */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-2">Organizational Structure</h2>
        <p> {/* Flowchart or description */} </p>
      </section>
      {/* CEO Message */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-2">CEO's Message</h2>
        <p> {/* CEO message content */} </p>
      </section>
      {/* Board of Directors */}
      <section>
        <h2 className="text-2xl font-semibold mb-2">Board of Directors</h2>
        <p> {/* Board profiles, images, roles */} </p>
      </section>
    </main>
  );
}